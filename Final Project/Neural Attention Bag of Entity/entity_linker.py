...
class EntityLinker(object):
    def __init__(self, data_file): #the data file seems to be a dictionary?
    ...
    def build(dump_db, tokenizer, out_file, min_link_prob, min_prior_prob, min_link_count, max_mention_length,
        ...
        with tqdm(total=dump_db.page_size(), mininterval=0.5) as pbar:
            ...
            with closing(Pool(pool_size, initializer=EntityLinker._initialize_worker, initargs=initargs)) as pool: #Pool 和multi-processing有关
